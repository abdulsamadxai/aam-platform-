...
export default function CompetitionsPage() {
  const [comps] = useState(() => getAllCompetitions());
      ...
      <div className="container py-24 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {comps.map((comp) => (
            <div
              key={comp.id}
              className="group border-4 border-white bg-white/5 p-10 space-y-8 relative overflow-hidden transition-all hover:bg-white/10"
            >

...
import { getAllJobs, saveJobApplication } from "@/lib/mock-data";
...
import { Plus, X, CheckCircle2, Briefcase, User, Mail, Phone, Globe, Clock, FileText, Building2 } from "lucide-react";
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    setTimeout(() => {
      const application: JobApplication = {
        ...
        job_title: applyingToJob!.title,
        company_name: applyingToJob!.company_name,
        ...form,
        status: "new",

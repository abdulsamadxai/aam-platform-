  ...
  return (
    <div className="container py-24 max-w-5xl space-y-24">
      ...
      <div className="space-y-4 border-l-8 border-black pl-8">
        ...
        <p className="text-sm font-black uppercase tracking-[0.4em] text-mono-400">Visual Documentation Repository Protocol</p>
      </div>
            ...
            <CardFooter className="bg-black text-white p-10 flex justify-between items-center">
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[8px] font-bold uppercase tracking-widest text-mono-400">VOLUME WILL BE INITIALIZED IN THE CLOUD REGISTRY.</p>
                </div>
              </div>
              <Button
                type="submit"
        ...
        <div className="space-y-12">
          <Card className="border-4 border-black rounded-none shadow-none bg-white">
            ...
            <CardContent className="p-8 text-center space-y-6">
              <div className="aspect-square bg-mono-100 border-2 border-black border-dashed flex flex-col items-center justify-center gap-4 text-center p-6">
                <Layers className="h-8 w-8 text-mono-300" />
                <p className="text-[9px] font-black uppercase tracking-widest text-mono-400 leading-relaxed">
